                  ...
                  <div className={styles["all-menu-other"]}>
                    <div className={styles["item"]}>
                      <h3 className={styles["name"]}>
                        <Link href={"/components/donghothuysi"}>
                          ĐỒNG HỒ THỤY SĨ
                        </Link>
                      </h3>
                      <Link
                    ...
                    <div className={styles["item"]}>
                      <h3 className={styles["name"]}>
                        <Link href={"/components/donghonhatban"}>
                          ĐỒNG HỒ NHẬT BẢN
                        </Link>
                      </h3>
                      <Link
                    ...
                    <div className={styles["item"]}>
                      <h3 className={styles["name"]}>
                        <Link href={"/components/trangsucDW"}>
                          TRANG SỨC DW
                        </Link>
                      </h3>
                      <Link
                    ...
                    <div className={styles["item"]}>
                      <h3 className={styles["name"]}>
                        <Link href={"/components/daydeodongho"}>
                          DÂY ĐEO ĐỒNG HỒ
                        </Link>
                      </h3>
                      <Link
                    ...
                    <div className={styles["item"]}>
                      <h3 className={styles["name"]}>
                        <Link href={"/components/donghodeban"}>
                          ĐỒNG HỒ ĐỂ BÀN
                        </Link>
                      </h3>
                      <Link
                    ...
                    <div className={styles["item"]}>
                      <h3 className={styles["name"]}>
                        <Link href={"/components/donghobaothuc"}>
                          ĐỒNG HỒ BÁO THỨC
                        </Link>
                      </h3>
                      <Link
                    ...
                    <div className={styles["item"]}>
                      <h3 className={styles["name"]}>
                        <Link href={"/components/trangsucCK"}>
