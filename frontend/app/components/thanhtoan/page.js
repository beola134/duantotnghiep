        ...
        <div className={styles.checkoutContainer}>
                    ...
                    <div className={styles.paymentMethods}>
                        ...
                        <div className={styles.paymentOptions}>
                            <div className={styles.paymentOption}>
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSjgeVcZ4-Ce-KW8KlVF1JN88mRv1moJbpUg&s" alt="Thanh toán khi nhận hàng" />
                                <span>Thanh toán khi nhận hàng</span>
                            </div>
                            <div className={styles.paymentOption}>
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGxsoe7iPccCnGraliGFCLCvbg3bO3PDtELQ&s" alt="Thanh toán bằng tài khoản ngân hàng" />
                                <span>Thanh toán bằng tài khoản ngân hàng</span>
                            </div>
                            <div className={styles.paymentOption}>
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTp1v7T287-ikP1m7dEUbs2n1SbbLEqkMd1ZA&s" alt="Thanh toán bằng VNPay" />
                                <span>Thanh toán bằng VNPay</span>
                            </div>
                            <div className={styles.paymentOption}>
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmzB5_qUPLtN4E3LuVFxMvy92q1Vo10N_m2Q&s" alt="Thanh toán ví điện tử Momo" />
                    ...
                    <div className={styles.productInfo}>
                        <div className={styles.productLeft}>
                            ...
                            <div className={styles.productImage}>
                                <img src="https://donghoduyanh.com/images/products/2023/07/31/resized/an8201-57l_1690775073.jpg" alt="ĐỒNG HỒ NAM ORIENT" />
                            </div>
                        </div>
            ...
            <aside className={styles.cartSummary}>
                ...
                <div className={styles.orderSummary}>
                    <p>Tổng tiền hàng: <span className={styles.price}>999.000đ</span></p>
                    <p>Ưu đãi: <span className={styles.price}>0đ</span></p>
                    <p className={styles.totalAmount}>Tổng thanh toán: <span className={styles.price}>999.000đ</span></p>
                </div>
