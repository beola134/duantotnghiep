...
export default function Detail({ params }) {
  ...
  useEffect(() => {
    const fetchRelated = async () => {
      try {
        const response = await fetch(
          `http://localhost:5000/product/related/${params.id}`
        );
        if (!response.ok) {
          throw new Error("Lỗi không thể tải dữ liệu");
        }
  ...
  useEffect(() => {
    const getAllComment = async () => {
      ...
      try {
        const response = await fetch(
          `http://localhost:5000/comment/getAll/${params.id}?page=${currentPage}`
        );
        if (!response.ok) {
          throw new Error("Lỗi không thể tải dữ liệu");
        }
        ...
        <div className={styles.frameLeft}>
          <div className={styles.discountPro}>
            ...
            <span id="discount-pro">
              {roundDiscount(
                Math.round(
                  ((product.gia_san_pham - product.gia_giam) /
      ...
      <div className={`${styles.bottomDetail} ${styles.container}`}>
        <div className={styles.bottomDetail1}>
            ...
            <ul className={styles.productTabsUl}>
              ...
              <li
                ...
                <Link
                  ...
                  href="#"
                  onClick={(event) =>
                    handleTabClick("Hướng dẫn sử dụng", event)
                  }>
          ...
          <div className={styles.productTabContent}>
            <div
              id="prodetails-tab1"
              className={`${styles.prodetailsTab} ${
                selectedTab === "Mô tả chi tiết" ? "" : styles.hide
              }`}>
            ...
            <div
              id="prodetails-tab2"
              className={`${styles.prodetailsTab} ${
                selectedTab === "Chế độ bảo hành" ? "" : styles.hide
              }`}>
              <blockquote cite="">
            ...
            <blockquote>
              <div
                id="prodetailsTab3"
                className={`${styles.prodetailsTab} ${
                  selectedTab === "Hướng dẫn sử dụng" ? "" : styles.hide
                }`}>
                        ...
                        <span>
                          <span>
                            <img
                              alt=""
                              height="500"
                              src="/image/item/detail-huongdansudung.jpg"
                              width="850"
                            />
                          </span>
                        </span>
                      ...
                      <div
                        ...
                        <div className={styles.item}>
                          <div className={styles.frameInner}>
                            ...
                            <span className={styles.duongKinh}>
                              {duong_kinh}
                            </span>
            ...
            <div className={styles.commentsWebsite}>
              ...
              <div className={styles.comments}>
                ...
                <form
                  ...
                  <div className={styles.ratingArea}>
                    <span id="ratings" className={styles.cls}>
                      {[1, 2, 3, 4, 5].map((value) => (
                        <i
                          key={value}
                          className={`${styles.iconV1} ${
                            value <= star ? styles.starOn : styles.starOff
                          }`}
                  ...
                  {/* show bình luận  */}
                  <div
                    className={`${styles.commentSection} ${styles.container}`}>
                    {Array.isArray(comments) && comments.length > 0 ? (
                            ...
                            <div className={styles.content}>
                              <div className={styles.header}>
                                <span className={styles.name}>
                                  {comment.user?.ten_dang_nhap || "Ẩn danh"}
                                </span>
                      ...
                      <p style={{ color: "#999" }}>
                        Mời bạn nhận xét về sản phẩm, hãy bình luận có văn hoá
                        để tránh bị khoá tài khoản.
                      </p>
                    )}
                  </div>
                </form>
