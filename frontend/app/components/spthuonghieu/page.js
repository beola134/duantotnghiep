...
export default function SPThuonghieu() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await fetch("http://localhost:5000/product/category/d3952e6b-ced8-40aa-bae6-659d88fa59d8");
  ...
  return (
    <>
      <div className="container-header">
        <div id="main-container" className="mt20">
          <div className="main-column">
            <div className="center-1col">
              <div className="clear"></div>
              <div className="hiden">
                <div className="clear"></div>
                <div className="block-product-filter cls">
                  {/*Giới tính */}
                  <div className="field-area field-item">
                    <div className="field-name normal field">Giới tính</div>
                    <div className="field-label filters-in-field filters-in-field-0-column">
                      <span className="close">x</span>
                      <div className="filters-in-field-inner cls">
                  ...
                  {/* Thương hiệu  */}
                  <div className="field-area field-item">
                    <div className="field-name normal field field-opened">Thương hiệu</div>
                    <div id="brand" className="field-label filters-in-field filters-in-field-3-column filter-brand">
                      <span className="close">x</span>
                      <div className="filters-in-field-inner cls">
                  ...
                  {/* Mức giá */}
                  <div className="field-area field-item">
                    <div className="field-name normal field field-opened">Mức giá</div>
                    <div id="price" className="field-label filters-in-field filters-in-field-1-column filter-4-price">
                      <span className="close">x</span>
                      <div className="filters-in-field-inner cls">
                        <div className="cls item">
                  ...
                  {/* Khuyến mãi */}
                  <div className="field-area field-item">
                    <div className="field-name normal field field-opened" data-id="id-field-discount">
                      Khuyến mại
                    </div>
                    <div
                      id="discount"
                      className="field-label filters-in-field filters-in-field-1-column filter-4-discount"
                    >
                      <span className="close">x</span>
                      <div className="filters-in-field-inner cls">
                        <div className="cls item">
                  ...
                  {/* Loại máy */}
                  <div className="field-area field-item">
                    <div className="field-name normal field field-opened" data-id="id-field-loai-may">
                      Loại máy
                    </div>
                    <div
                      id="loai-may"
                      className="field-label filters-in-field filters-in-field-1-column filter-4-loai-may"
                    >
                      <span className="close">x</span>
                      <div className="filters-in-field-inner cls">
                        <div className="cls item">
                  ...
                  {/*Đường kính */}
                  <div className="field-area field-item">
                    <div className="field-name normal field field-opened" data-id="id-field-duong-kinh">
                      Đường kính
                    </div>
                    <div
                      id="duong-kinh"
                      className="field-label filters-in-field filters-in-field-1-column filter-4-duong-kinh"
                    >
                      <span className="close">x</span>
                      <div className="filters-in-field-inner cls">
                        <div className="cls item">
                  ...
                  {/*Chất liệu dây  */}
                  <div className="field-area field-item">
                    <div className="field-name normal field field-opened" data-id="id-field-chat-lieu-day">
                      Chất liệu dây
                    </div>
                    <div
                      id="chat-lieu-day"
                      className="field-label filters-in-field filters-in-field-2-column filter-4-chat-lieu-day"
                    >
                      <span className="close">x</span>
                      <div className="filters-in-field-inner cls">
                        <div className="cls item">
                  ...
                  {/*Chất liệu vỏ */}
                  <div className="field-area field-item">
                    <div className="field-name normal field field-opened" data-id="id-field-chat-lieu-vo">
                      Chất liệu vỏ
                    </div>
                    <div
                      id="chat-lieu-vo"
                      className="field-label filters-in-field filters-in-field-2-column filter-4-chat-lieu-vo"
                    >
                      <span className="close">x</span>
                      <div className="filters-in-field-inner cls">
                        <div className="cls item">
                  ...
                  {/* Mặt kính */}
                  <div className="field-area field-item">
                    <div className="field-name normal field field-opened" data-id="id-field-mat-kinh">
                      Mặt kính
                    </div>
                    <div
                      id="mat-kinh"
                      className="field-label filters-in-field filters-in-field-1-column filter-4-mat-kinh"
                    >
                      <span className="close">x</span>
                      <div className="filters-in-field-inner cls">
                        <div className="cls item">
                  ...
                  {/*Màu mặt */}
                  <div className="field-area field-item">
                    <div className="field-name normal field field-opened" data-id="id-field-mau-mat">
                      Màu mặt
                    </div>
                    <div
                      id="mau-mat"
                      className="field-label filters-in-field filters-in-field-2-column filter-4-mau-mat"
                    >
                      <span className="close">x</span>
                      <div className="filters-in-field-inner cls">
                        <div className="cls item">
                  ...
                  {/*Phong cách */}
                  <div className="field-area field-item">
                    <div className="field-name normal field field-opened" data-id="id-field-phong-cach">
                      Phong cách
                    </div>
                    <div
                      id="phong-cach"
                      className="field-label filters-in-field filters-in-field-1-column filter-4-phong-cach"
                    >
                      <span className="close">x</span>
                      <div className="filters-in-field-inner cls">
                        <div className="cls item">
                  ...
                  {/*Kiểu dáng */}
                  <div className="field-area field-item">
                    <div className="field-name normal field field-opened" data-id="id-field-kieu-dang">
                      Kiểu dáng
                    </div>
                    <div
                      id="kieu-dang"
                      className="field-label filters-in-field filters-in-field-1-column filter-4-kieu-dang"
                    >
                      <span className="close">x</span>
                      <div className="filters-in-field-inner cls">
                        <div className="cls item">
                  ...
                  {/*Xuất xứ thương hiệu */}
                  <div className="field-area field-item">
                    <div className="field-name normal field field-opened" data-id="id-field-xuat-xu-thuong-hieu">
                      Xuất xứ thương hiệu
                    </div>
                    <div
                      id="xuat-xu-thuong-hieu"
                      className="field-label filters-in-field filters-in-field-0-column filter-4-xuat-xu-thuong-hieu"
                    >
                      <span className="close">x</span>
                      <div className="filters-in-field-inner cls">
                        <div className="cls item">
              ...
              <div className="container">
                ...
                <div className="all-summary">
                  <div className="summary-content-filter description">
                    <p>
                ...
                <div className="products-cat">
                  <div className="block-products-filter">
                    <div className="block-product-filter cls">
                      ...
                      {/*Thương hiệu */}
                      <div className="field-area field-item">
                        <div className="field-name normal field field-opened" data-id="id-field-bard">
                          Thương hiệu
                        </div>
                        <div
                          id="brand"
                          className="field-label filters-in-field filters-in-field-3-column filter-4-brand"
                        >
                          <span className="close">x</span>
                          <div className="filters-in-field-inner cls">
                            <div className="cls item">
                      ...
                      {/*Mức giá */}
                      <div className="field-area field-item">
                        <div className="field-name normal field field-opened" data-id="id-field-price">
                          Mức giá
                        </div>
                        <div
                          id="price"
                          className="field-label filters-in-field filters-in-field-1-column filter-4-price"
                        >
                          <span className="close">x</span>
                          <div className="filters-in-field-inner cls">
                            <div className="cls item">
                      ...
                      <div className="field-area field-item">
                        ...
                        >
                          ...
                          <div className="filters-in-field-inner cls">
                            <div className="cls item">
                              <Link rel="nofollow" href="#l" title="Dây da">
                                Dây da
                              </Link>
                            </div>
                            <div className="cls item">
                  ...
                  <div className="field-title">
                    <div className="title-name">
                      <div className="cat-title">
                        <div className="cat-title-main" id="cat-dong-ho">
                    ...
                    <select className="order-select" name="order-select">
                  ...
                  <section className="products-cat-frame">
                    <div className="products-cat-frame-inner">
                      <div className="product-grid cls">
                        {/* item-1 */}
                          ...
                          return (
                            <div key={_id} className="item">
                              <div className="frame-inner">
                                ...
                                <h3>
                                  <Link className="name" href="#" title={ten}>
                                    <span className="cat-name">{ten_san_pham}</span>
                                    {ma_san_pham}
                                  </Link>
                                </h3>
                                <span className="loai-may">{loai_may}</span>
                                <span className="row-lm">|</span>
                                <span className="duong-kinh">{duong_kinh}</span>
                                <div className="price-arae">
                                  <div className="price-old">
                                    Giá: <span>{gia_san_pham.toLocaleString("vi-VN")}₫</span>
                                  </div>
                                  <div className="price-current">Giá KM: {gia_giam.toLocaleString("vi-VN")} ₫</div>
                                </div>
                  ...
                  <div className="pagination">
                    <span title="Page 1" className="current">
                      <span>1</span>
                    </span>
                    <Link className="other-page" title="Page 2" href="#">
                      <span>2</span>
                    </Link>
                    <Link className="other-page" title="Page 3" href="#">
                      <span>3</span>
                    </Link>
                    <Link className="other-page" title="Page 4" href="#">
                      <span>4</span>
                    </Link>
                    <b>...</b>
                    <Link className="next-page" title="Next page" href="#">
                      ›
                    </Link>
                    <Link className="last-page" title="Last page" href="#">
                      ››
                    </Link>
                  </div>
                </div>
                <div className="clear"></div>
                {/* đánh giá start */}
                <div className="evaluate-cat">
                  <div className="rating-area cls">
                    <span id="ratings" className="cls">
                      <i className="icon_v1 star_on" id="rate_1" value="1"></i>
                      <i className="icon_v1 star_on" id="rate_2" value="2"></i>
                      <i className="icon_v1 star_on" id="rate_3" value="3"></i>
                      <i className="icon_v1 star_off" id="rate_4" value="4"></i>
                      <i className="icon_v1 star_off" id="rate_5" value="5"></i>
                    </span>
                    <span className="rating-note">Nhấn vào đây để đánh giá</span>
                  </div>
                </div>
