            ...
            <div id="main-container" className={cx("mt20")}>
                ...
                <div className={cx("center-1col")}>
                    ...
                    <div className={cx("summary-content-filter", "description")}>
                        ...
                        &nbsp;được coi là một món đồ nội thất trang trí&nbsp;tuyệt vời, biến mỗi
                        không gian sống trở nên ấm ấp, sinh động, tươi vui hoặc theo bất kỳ phong
                        cách nào mà bạn muốn. Dù bạn có là người kỹ tính luôn yêu cầu mọi thứ phải
                        cầu toàn đi chăng nữa thì thế giới phong phú của
                        <em>
                            <strong>
                        ...
                        &nbsp;với đầy đủ các thiết kế, kiểu dáng, kích thước, màu sắc...đều sẽ
                        khiến bạn hài lòng.
                        </p>
                    </div>
                            ...
                            {products.map((item) =>(
                                 <div className={cx("item")}>
                                    ...
                                    <h3>
                                        ...
                                        className={cx("name")}
                                        href="#"
                                        title="Đồng hồ treo tường Rhythm CMG620NR04"
                                        >
                                        <span className={cx("cat-name")}>
                                            {item.ten_san_pham}
                                        </span>
                    ...
                    <div className={cx("evaluate-cat")}>
                        ...
                        <div className={cx("summary-content-cat", "description", "height-auto")}>
                            ...
                            <span style={{ color: "#2980b9" }}>
                                <strong>
                                NÂNG CẤP&nbsp;KHÔNG GIAN SỐNG&nbsp;CỦA BẠN VỚI ĐỒNG HỒ TREO
                                TƯỜNG TRANG TRÍ
                                </strong>
                            </span>
                            </h2>
                            ...
                            <p dir="ltr" style={{ textAlign: "justify" }}>
                            Bạn đã bao giờ nghĩ đến trước khi đồng hồ được phát minh, người
                            xưa đã theo dõi thời gian nhờ chuyển động của mặt trời như thế nào
                            chưa. Đồng hồ giúp chúng ta quản lý cuộc sống của mình.
                            <strong>
                                <em>Đồng hồ treo tường</em>
                            </strong>
                            &nbsp;là một vật dụng quan trọng trong gia đình&nbsp;giúp bạn luôn
                            đúng giờ, đến đúng nơi, đúng lúc để có được thành công trong cuộc
                            sống.
                            </p>
                            ...
                            <p dir="ltr" style={{ textAlign: "justify" }}>
                            Nếu muốn cạnh tranh với thế giới ngày nay để thành công, điều rất
                            quan trọng là phải biết ảnh hưởng của thời gian đối với cuộc sống
                            của chúng ta. Để coi trọng thời gian, bạn nên đúng giờ, bạn cần có
                            <em>
                                <strong>đồng hồ treo tường</strong>
                            </em>{" "}
                            xung quanh mình. Và thực sự với một hoặc nhiều chiếc đồng hồ treo
                            tường hiện diện trong không gian sống của bạn nó sẽ khiến bạn và
                            gia đình mình kiểm soát được thời gian trong mọi hoạt động của
                            ...
                            &nbsp;không chỉ giúp bạn nhìn thấy đúng thời điểm và nó cũng là
                            một phần trang trí rất tuyệt vời cho ngôi nhà, văn phòng làm việc
                            hay bất cứ không gian nào khác. Bên cạnh đó, lựa chọn
                            <em>
                                <strong>
                            ...
                            &nbsp;là một trong những ưu tiên hàng đầu khi nghĩ đến thiết kế
                            nội thất trong căn nhà của bạn. Một không gian sống hiện đại được
                            hưởng lợi từ những đường nét tinh tế trên những chiếc&nbsp;
                            <strong>
                                <a href="#">
                            ...
                            <li style={{ textAlign: "justify" }}>
                                <a href="#">
                                HƯỚNG DẪN LỰA CHỌN ĐỒNG HỒ TREO TƯỜNG CHO NGÔI NHÀ CỦA BẠN
                                </a>
                            </li>
                            <li style={{ textAlign: "justify" }}>
                                <a href="#">
                                TOP CÁC MẪU ĐỒNG HỒ TREO TƯỜNG&nbsp;TRANG TRÍ PHÒNG KHÁCH ĐẸP
                                </a>
                            </li>
                            <li style={{ textAlign: "justify" }}>
                            ...
                            <span style={{ color: "#2980b9" }}>
                                <em>
                                <strong>DUY ANH WATCH</strong> luôn&nbsp;mang đến cho khách
                                hàng những chiếc
                                <strong>đồng hồ treo tường đẹp</strong>&nbsp;đáp ứng hoàn
                                hảo&nbsp;cho cuộc&nbsp;sống hiện&nbsp;đại, thể hiện nét thẩm
                                mỹ tối giản và thêm sức hấp dẫn trực quan cho không gian sống
                                của mình.
                                </em>
                            </span>
                            </p>
                            ...
                            <strong>
                                <em>
                                Hệ thống&nbsp;mạng xã hội của Đồng hồ Duy Anh (Duy Anh Watch)
                                </em>
                            </strong>
                            </p>
                            <ul>
