export default function Detail() {
  return (
    <>
      <div class="top-product-detail container cls">
        ...
        <div class="frame-left">
          ...
          <div style="position: relative; left: 0px; text-align: center; margin-bottom: 20px">
            <img
              class="img-responsive bk-product-image"
          ...
          <div class="thumbs">
            <div class="list-item">
              <div class="item" style="max-width: calc(100% / 5 -10px)">
        ...
        <div class="frame-center">
          <div class="name-table mt20">
            <div class="logo-manufactory">
              <img class="image-gift-cat" src="../public/img/item/brand1.png" alt="" />
            </div>
            <div class="product-name">
              <h1 class="bk-product-name">Đồng hồ nam Tissot Chemin des Tourelles Powermatic 80 T139.807.22.038.00</h1>
              <div class="item-ss-main item-ss item-ss-19005">
                <span class="icon-ss"> </span>
                <span class="txt-ss">So sánh</span>
              </div>
            </div>
            <div class="code-manu mt10 cf">
              <span class="rate rate-head">
                ...
                <span class="hide">5</span>
                <a class="rate-count" href="" title="Đánh giá sản phẩm này ">
                  {" "}
                  (<span>1</span> đánh giá )
                </a>
              </span>
            </div>
            <span class="code-product">Mã sản phẩm: T139.807.22.038.00</span>
            <ul class="info-main-filter">
              <li class="cf">
                <div class="li-left fl">Loại máy</div>
                <span class="fl">:</span>
                <div class="li-right fl">Automatic (Máy cơ tự động )</div>
              </li>
              <li class="cf">
                <div class="li-left fl">Đường kính</div>
                <span class="fl">:</span>
                <div class="li-right fl">39mm</div>
              </li>
            ...
            {/* <!--  --> */}
            <div class="box-gift">
              <div class="title-gift">Khuyến mãi</div>
              <div class="gift">
                <p>
                  Giảm&nbsp;
                ...
                <p>
                  ...
                  <strong>
                    <a href="#">
                      <span style="color: #3498db">Casio</span>
                    </a>
                    <span style="color: #3498db">,</span>
                    <a href="#">
                      <span style="color: #3498db">Calvin Klein</span>
                    </a>
                  </strong>
                </p>
              ...
              <form name="form_regis_phone" id="form_regis_phone" method="post">
                <div class="wrapper-infor">
                  <input
                    ...
                    class="keyword txt-phone input-text"
                  />
        ...
        <div class="frame-right">
          <div class="box-price-right">
            <div class="box-price-right-top">
              <div class="price-old">
                <span>Gía</span>
                <span class="price-old">26.950.000₫</span>
              </div>
              <div class="price-current">
                <div class="title-price-current">Gía KM:</div>
                <div class="number-price-current">
                  <input type="hidden" value="1" class="bk-product-qty" />
                  <span class="bk-product-price" data-price="24255000" data-price-old="26950000">
                    24.255.000₫
                  </span>
                </div>
                <div class="note-vat">(Gía trên đã bao gồm VAT)</div>
              </div>
              <div class="clear"></div>
              <div class="box-price-right-bot">
                <div class="btn-buy buy-row cls">
                  <form action="">
                    <button type="submit" class="bt-buy-sp buy-sp submit">
                      Mua ngay
                    </button>
                    <button class="bt-buy-sp buy-sp submit" type="button">
                      Thêm vào giỏ hàng
                    </button>
                  </form>
                  <button style="margin-bottom: 20px" type="button" class="bt-buy-sp buy-sp submit">
                    Tư vấn miễn phí
                  </button>
                </div>
		...
		C32.666,7.326,25.339,0,16.333,0z"
                  ...
                  <a title="hotline mua hàng" href="#" class="phone-call">
                    024.3991.8668
                  </a>
                </div>
              </div>
      ...
      <div class="clear"></div>
      <div class="product-pos0 container">
        <div class="block-strengths strengths-0 blocks-strengths blocks0 block">
          <div class="strengths-retangle4-block cls">
      ...
      <div class="bottom-detail container">
        <div class="bottom-detail-1">
          <div class="product-tab">
            <ul class="product-tabs-ul cf clearfix">
              <li class="scroll-nav-item fl active">
                <a class="scroll-nav-link" href="#">
                  <span>Mô tả chi tiết</span>
                </a>
              </li>
              <li class="scroll-nav-item fl">
                <a class="scroll-nav-link" href="#">
          ...
          {/* <!-- detail-product --> */}
          <div class="product-tab-content mt20">
            <div id="prodetails-tab1" class="prodetails-tab cf">
              <div class="top-info-detail">
                <div class="title-detail-char">Thông tin sản phẩm</div>
                <div class="table-condensed compare-table">
                  <table class="table" border="0" cellpadding="0" width="100%">
                    <tbody>
                      <tr class="tr-0" valign="top">
                        <td class="title-charactestic" width="40%">
                          Giới tính:
                        </td>
                        <td class="content-charactestic">Nam</td>
                      </tr>
                      <tr class="tr-1" valign="top">
                        <td class="title-charactestic" width="40%">
                          Kiểu dáng:
                        </td>
                        <td class="content-charactestic">Mặt tròn</td>
                      </tr>
                      <tr class="tr-0" valign="top">
                        <td class="title-charactestic" width="40%">
                          Loại máy:
                        </td>
                        <td class="content-charactestic">Automatic (Máy cơ tự động)</td>
                      </tr>
                      <tr class="tr-1" valign="top">
                        <td class="title-charactestic" width="40%">
                          Phong cách:
                        </td>
                        <td class="content-charactestic">Hiện đại</td>
                      </tr>
                      <tr class="tr-0" valign="top">
                        <td class="title-charactestic" width="40%">
                          Mặt kính:
                        </td>
                        <td class="content-charactestic">Sapphire</td>
                      </tr>
                      <tr class="tr-1" valign="top">
                        <td class="title-charactestic" width="40%">
                          Đường kính:
                        </td>
                        <td class="content-charactestic">39mm</td>
                      </tr>
                      <tr class="tr-0" valign="top">
                        <td class="title-charactestic" width="40%">
                          Chất liệu vỏ:
                        </td>
                        <td class="content-charactestic">Thép không gỉ mạ vàng công nghệ PVD</td>
                      </tr>
                      <tr class="tr-1" valign="top">
                        <td class="title-charactestic" width="40%">
                          Độ dày:
                        </td>
                        <td class="content-charactestic">11.2mm</td>
                      </tr>
                      <tr class="tr-0" valign="top">
                        <td class="title-charactestic" width="40%">
                          Chất liệu dây:
                        </td>
                        <td class="content-charactestic">Thép không gỉ 316L mạ vàng công nghệ PVD</td>
                      </tr>
                      <tr class="tr-1" valign="top">
                        <td class="title-charactestic" width="40%">
                          Size dây:
                        </td>
                        <td class="content-charactestic">20mm</td>
                      </tr>
                      <tr class="tr-0" valign="top">
                        <td class="title-charactestic" width="40%">
                          Độ chịu nước:
                        </td>
                        <td class="content-charactestic">50m</td>
                      </tr>
                      <tr class="tr-1" valign="top">
                        <td class="title-charactestic" width="40%">
                          Lug to Lug:
                        </td>
                        <td class="content-charactestic">45mm</td>
                      </tr>
                      <tr class="tr-0" valign="top">
                        <td class="title-charactestic" width="40%">
                          Tính năng khác:
                        </td>
                        <td class="content-charactestic">
                      ...
                      <tr class="tr-1" valign="top">
                        ...
                        <td class="content-charactestic">2 năm quốc tế</td>
                      </tr>
                      <tr class="tr-0" valign="top">
                        <td class="title-charactestic" width="40%">
                          Màu mặt:
                        </td>
                        <td class="content-charactestic">Trắng</td>
                      </tr>
                      <tr class="tr-1" valign="top">
                        <td class="title-charactestic" width="40%">
                          Bảo hành Duy Anh:
                        </td>
                        <td class="content-charactestic">5 năm (đã bao gồm Bảo hành Quốc tế).</td>
                      </tr>
                      <tr class="tr-0" valign="top">
                        <td class="title-charactestic" width="40%">
                          Xuất xứ thương hiệu:
                        </td>
                        <td class="content-charactestic">Thụy sĩ</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div id="prodetails-tab2" class="prodetails-tab hide">
            ...
            <blockquote cite="donghoduyanh.com">
              <div id="prodetails-tab3" class="prodetails-tab hide">
                <div class="tab">
                  <button class="tablinks1 tab-boder tab-cach-chinh-dong-ho active">
                    <span class="text">Cách chỉnh đồng hồ</span>
                  </button>
                  <button class="tablinks1 tab-boder tab-huong-dan-chon-size">
                    <span>Hướng dẫn chọn size</span>
                  </button>
                  <button class="tablinks1 tab-boder tab-muc-do-chong-nuoc-cua-dong-ho">
                    <span>Mức độ chống nước của đồng hồ</span>
                  </button>
                  <button class="tablinks1 tab-boder tab-huong-dan-ve-sinh-dong-ho">
                    <span>Hướng dẫn vệ sinh đồng hồ</span>
                  </button>
                </div>
                <div id="tab-2" class="tabcontent1 description">
                  <p style="text-align: justify">
                    <br />
                  ...
                  <div
                    ...
                    style="height: 0; overflow: hidden; padding-bottom: 56.25%; padding-top: 30px; position: relative"
                  >
                    <iframe
                      allow=";"
                      allowfullscreen=""
                  ...
                  <p style="text-align: justify">
                    <span style="font-size: 13pt">
                      <span>
                        <span>
                          <span>
                            - &nbsp;Một số dòng đồng hồ cao cấp&nbsp;hay một số dòng đồng hồ có sử dụng gioăng cao su để
                            chống vào nước thì nút điều chỉnh không kéo ra ngay được mà phải xoay vặn (theo chiều ngược
                            kim đồng hồ) để mở nút điều chỉnh, sau đó mới kéo nhẹ ra các nấc cần điều chỉnh. Sau khi
                            điều chỉnh xong phải đóng nút điều chỉnh về vị trí ban đầu, ấn nút điều chỉnh vào đồng thời
                            xoay vặn (theo chiều kim đồng hồ) đóng chặt nút điều chỉnh để tránh nước bị thẩm thấu vào
                            máy.
                          </span>
                        </span>
                      </span>
        ...
        <div class="bottom-detail-r">
          <div class="title-box">Chứng nhận chính hãng</div>
      ...
      <div class="clear"></div>
      {/* <!--  --> */}
      <div class="tab-content cls container">
        <div class="tab-content-chars">
          <div class="title-description">
            Mô tả Đồng hồ nam Tissot Chemin des Tourelles Powermatic 80 T139.807.22.038.00
          </div>
          <div class="prodetails-tab-content">
            <div class="tab-content-right">
              <div class="description boxdesc" id="boxdesc">
                <div id="box-content-linfo" style="max-height: 400px">
                  <div class="box-content-linfo-inner">
                    <p>
                ...
                <div class="readmore" id="readmore-desc">
                  <span class="closed">Hiển thị thêm</span>
                </div>
                {/* <!--  --> */}
      ...
      <div class="related-products favourite mt20 text-center container">
        ...
        <div class="products-blocks-wrapper block slideshow-hot cls">
          <div
            class="slideshow-hot-list products-blocks-slideshow-hot owl-carousel owl-theme owl-responsive-1170 owl-loaded"
                    ...
                    <div class="frame-inner">
                      ...
                      <h2>
                        <a
                          ...
                          class="name"
                        >
                          <span class="cat-name">Đồng hồ nam Tissot Chemin des Tourelles</span>
                          T139.836.16.261.00
                        </a>
                      </h2>

                      <span class="loai-may">Automatic</span>
                      <span class="row-lm">|</span>
                      <span class="duong-kinh">39mm</span>
                      <div class="price-arae">
                        <div class="price-old">
                          Giá: <span>27.300.000₫</span>
                        </div>
                        <div class="price-current">Giá KM: 24.570.000₫</div>
                      </div>
                      ...
                      <div class="item-ss item-ss-9093">
                        <span class="icon-ss"></span>
                        <span class="txt-ss"> So sánh </span>
                      </div>
                ...
                <div class="owl-item cloned" style="width: 226px; margin-right: 10px">
                  <div class="item">
                    <div class="frame-inner">
                      ...
                      <h2>
                        <a href="#" title="Tissot Chemin Des Tourelles  T099.407.22.037.00" class="name">
                          <span class="cat-name">Đồng hồ nam Tissot Chemin Des Tourelles</span>
                          T099.407.22.037.00
                        </a>
                      </h2>
                      ...
                      <span class="loai-may">Automatic</span>
                      <span class="row-lm">|</span>
                      <span class="duong-kinh">42mm</span>
                      <div class="price-arae">
                        <div class="price-old">
                          Giá: <span>28.700.000₫</span>
                        </div>
                        <div class="price-current">Giá KM: 25.830.000₫</div>
                      </div>
                      ...
                      <div class="item-ss item-ss-9093" data-id="9093" data-table="fs_products_dong_ho">
                        <span class="icon-ss"></span>
                        <span class="txt-ss"> So sánh </span>
                      </div>
                ...
                <div class="owl-item cloned" style="width: 226px; margin-right: 10px">
                  <div class="item">
                    <div class="frame-inner">
                      ...
                      <h2>
                        <a href="#" title="Tissot Chemin Des Tourelles T099.407.11.058.00" class="name">
                          <span class="cat-name">Tissot Chemin Des Tourelles </span>
                          T099.407.11.058.00
                        </a>
                      </h2>
                      ...
                      <div class="price-arae">
                        ...
                        <div class="price-current">Giá KM: 22.680.000₫</div>
                      </div>
                ...
                <div class="owl-item cloned" style="width: 226px; margin-right: 10px">
                  <div class="item">
                    <div class="frame-inner">
                      ...
                      <h2>
                        <a href="#" title="Tissot Chemin Des Tourelles Powermatic 80 T099.407.11.033.00" class="name">
                          <span class="cat-name">Tissot Chemin Des Tourelles </span>
                  ...
                  <div class="item">
                    <div class="frame-inner">
                      ...
                      <div class="price-arae">
                        ...
                        <div class="price-current">Giá KM: 22.365.000₫</div>
                      </div>
                ...
                <div class="owl-item active" style="width: 226px; margin-right: 10px">
                  <div class="item">
                    <div class="frame-inner">
                      ...
                      <h2>
                        <a href="#" title="Tissot Chemin Des Tourelles T099.407.36.038.00" class="name">
                          <span class="cat-name">Đồng hồ nam Tissot Chemin Des Tourelles </span>
                          T099.407.36.038.00
                        </a>
                      </h2>
                      ...
                      <div class="price-arae">
                        ...
                        <div class="price-current">Giá KM: 24.255.000₫</div>
                      </div>
                      ...
                      <div class="item-ss item-ss-20789">
                        <span class="icon-ss"></span>
                        <span class="txt-ss"> So sánh </span>
                      </div>
                ...
                <div class="owl-item active" style="width: 226px; margin-right: 10px">
                  <div class="item">
                    <div class="frame-inner">
                      ...
                      <h2>
                        <a href="#" title="Tissot Chemin Des Tourelles Powermatic 80 T099.407.36.448.00" class="name">
                          <span class="cat-name">Đồng hồ nam Tissot Chemin Des Tourelles </span>
                          T099.407.36.448.00
                        </a>
                      </h2>
                ...
                <div class="owl-item active" style="width: 226px; margin-right: 10px">
                  <div class="item">
                    <div class="frame-inner">
                      ...
                      <div class="item-ss item-ss-9249">
                        <span class="icon-ss"></span>
                        <span class="txt-ss"> So sánh </span>
                      </div>
                ...
                <div class="owl-item active" style="width: 226px; margin-right: 10px">
                  <div class="item">
                    <div class="frame-inner">
                      ...
                      <div class="item-ss item-ss-12124">
                        <span class="icon-ss"></span>
                        <span class="txt-ss"> So sánh </span>
                      </div>
                      ...
                      <figure class="product-image">
                        <a href="#" title="Tissot Chemin Des Tourelles T099.407.11.058.00">
                          <img
                            ...
                            height="363"
                            data-src="../public/img/product/detail-hinh6.webp"
                            srcset="../public/img/product/detail-hinh6.webps"
                            style="opacity: 1; display: block"
                          />
                        </a>
                      </figure>
                      ...
                      <figure class="product-image">
                        <a href="#" title="Tissot Chemin Des Tourelles Powermatic 80 T099.407.11.033.00">
                          <img
                            ...
                            height="363"
                            data-src="../public/img/product/detail-hinh7.webp"
                            srcset="../public/img/product/detail-hinh7.webps"
                            style="opacity: 1; display: block"
                          />
                        </a>
                      </figure>
                      ...
                      <figure class="product-image">
                        <a href="#" title="Đồng hồ nam Tissot Chemin des Tourelles Powermatic 80 T139.407.11.091.00">
                          <img
                            ...
                            height="363"
                            data-src="../public/img/product/detail-hinh8.webp"
                            srcset="../public/img/product/detail-hinh8.webps"
                            style="opacity: 1; display: block"
                          />
                        </a>
                      </figure>
                ...
                <div class="owl-item cloned" style="width: 226px; margin-right: 10px">
                  <div class="item">
                    <div class="frame-inner">
                      ...
                      <div class="item-ss item-ss-9181">
                        <span class="icon-ss"></span>
                        <span class="txt-ss"> So sánh </span>
                      </div>
      ...
      {/* <!--Đánh giá bình luận  --> */}
      <div class="bottom-detail container">
        <div id="prodetail-tab30" class="prodetails-tab-cm">
          <div class="tab-content-right">
            <div class="comments-website">
              ...
              <div class="comments">
                ...
                <form>
                  <input
                    type="text"
                    class="comment-keyword-wrapper"
                    id="comment-keyword"
                    name="comment-keyword"
                    placeholder="Tìm theo nội dung, người gửi..."
                  />
                  <button type="submit" class="comment-keyword-btn">
                    <i class="fa fa-search"></i>
                  </button>
                </form>
                <div id="-info-comment" class="cls"></div>
                {/* <!--  --> */}
                <form name="comment-add-form" id="comment-add-form" class="form-comment cls">
                  <label class="label-form">Nhận xét và đánh giá</label>
                  <div class="rating-area cls">
                    ...
                    <span class="rating-note">Nhấn vào đây để đánh giá</span>
                  </div>
                  <div class="_textarea">
                  ...
                  {/* <!--  --> */}
                  <div class="wrap-r cls" style="display: none">
                    <div class="title-mb">
                      Thông tin người gửi
