...
export default function ThemSanPham() {
  ...
  useEffect(() => {
    const fetchCategoriesData = async () => {
      try {
        const response = await fetch("http://localhost:5000/cate/getAllCateadmin");
        const data = await response.json();
  ...
  const validateForm = () => {
    const newErrors = {};
    const { ten_san_pham, ten, gia_san_pham, ma_san_pham, so_luong, id_thuong_hieu, hinh_anh, mo_ta } = formData;
          ...
          <form onSubmit={handleSubmit}>
            <div className={styles.container1}>
              ...
              <div className={styles.formGroup}>
                ...
                {errors.id_thuong_hieu && <span className="text-danger">{errors.id_thuong_hieu}</span>}
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={handleChange}
                />
                {errors.ten_san_pham && <span className="text-danger">{errors.ten_san_pham}</span>}
              </div>
              <div className={styles.formGroup}>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={handleChange}
                />
                {errors.gia_san_pham && <span className="text-danger">{errors.gia_san_pham}</span>}
              </div>
              <div className={styles.formGroup}>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={handleChange}
                />
                {errors.ma_san_pham && <span className="text-danger">{errors.ma_san_pham}</span>}
              </div>
              <div className={styles.formGroup}>
                ...
                {errors.so_luong && <span className="text-danger">{errors.so_luong}</span>}
              </div>
              <div className={styles.formGroup}>
              ...
              <div className={styles.formGroup}>
                ...
                {errors.xuat_xu && <span className="text-danger">{errors.xuat_xu}</span>}
              </div>
              <div className={styles.formGroup}>
              ...
              <div className={styles.formGroup}>
                ...
                <input type="file" id="hinh_anh" name="hinh_anh" onChange={handleFileChange} />
                {errors.hinh_anh && <span className="text-danger">{errors.hinh_anh}</span>}
              </div>
              <div className={styles.formGroup}>
                <label htmlFor="mo_ta">Mô tả sản phẩm</label>
                <textarea id="mo_ta" name="mo_ta" value={formData.mo_ta} onChange={handleChange} />
                {errors.mo_ta && <span className="text-danger">{errors.mo_ta}</span>}
              </div>
