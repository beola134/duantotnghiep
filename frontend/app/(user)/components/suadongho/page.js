    ...
    <nav className="lg:max-w-[1170px] md:max-w-[738px] sm:max-w-[357px] lg:ml-[10%] lg:mr-[10%] text-[14px] lg:text-[18px]">
      <div className="lg:flex w-full h-screen">
        <div className="lg:w-3/4 p-1 w-[90%] mr-[5%] ml-[5%]">
          ...
          <img
            src="/image/item/Untitled-3(2).jpg"
            alt=""
            srcset=""
            width="901px"
          />
          <section id="section1">
            ...
            <p className="mb-2.5 text-justify leading-relaxed hyphens-auto">
              ...
              tránh những hỏng hóc không mong muốn làm ảnh hưởng đến đồng hồ,
              hãy luôn chú ý đến thời điểm phải thay pin cho đồng hồ.
            </p>
            <img
              src="/image/item/Untitled-5.jpg"
              alt=""
              srcset=""
              width="901px"
            />
            <p className="mb-2.5 text-justify leading-relaxed hyphens-auto">
              ...
              tại Wristly, chúng tôi áp dụng chính sách “Thay pin miễn phí trọn
              đời” cho sản phẩm của quý khách.
            </p>
          </section>
          ...
          <section id="section2">
            ...
            <p className="mb-2.5 text-justify leading-relaxed hyphens-auto">
              ...
              cắt mắt dây kim loại, …. Chúng tôi hỗ trợ cung cấp các sản phẩm
              chính hãng được đặt hàng từ các thương hiệu đồng hồ hàng đầu thế
              giới, cùng với đó cũng cung cấp một số sản phẩm đến từ các nhà sản
              xuất dây đồng hồ nổi tiếng.
            </p>
            <img
              src="/image/item/Untitled-6.jpg"
              alt=""
              srcset=""
              width="901px"
            />
          ...
          <section id="section3">
            ...
            <p className="mb-2.5 text-justify leading-relaxed hyphens-auto">
              ...
              làm quan trọng nhưng lau dầu lại thường bị người dùng bỏ qua, nên
              đôi khi sử dụng đồng hồ mà người dùng lại không biết lí do vì sao
              đồng hồ của mình bị hỏng, chạy chậm hơn so với bình thường. Đối
              với đồng hồ pin, việc lau dầu sẽ tùy thuộc vào thời gian sử dụng
              và tình trạng của máy đồng hồ. Nhưng đối với đồng hồ cơ, đây là
              một quy trình vô cùng quan trọng. Đồng hồ cơ thường phải được lau
              dầu toàn bộ từ 3 hoặc 5 năm, tùy thuộc vào thông số kỹ thuật bộ
              máy của từng thương hiệu.
            </p>
          ...
          <section id="section4">
            ...
            <p className="mb-2.5 text-justify leading-relaxed hyphens-auto">
              ...
              quá trình sử dụng. Để hỗ trợ khách hàng, Trung tâm bảo hành
              Wristly hỗ trợ xử lí các trường hợp đồng hồ bị vào nước. Hãy nhanh
              chóng mang đồng hồ của bạn đến những trung tâm bảo hành uy tín để
              tránh tối đa thiệt hại do nước gây lên những linh kiên bên trong
              đồng hồ.
            </p>
          </section>
          <section id="section5">
            ...
            <p className="mb-2.5 text-justify leading-relaxed hyphens-auto">
              ...
              thể gây ra ảnh hưởng nghiêm trọng cho bộ máy hoặc mặt số. Nếu bạn
              gặp phải những vấn đề về mặt kính đồng hồ của mình, hãy mang chúng
              đến với Đồng hồ Wristly để nhận được những hỗ trợ kĩ thuật cần
              thiết với mức giá hợp lí.
            </p>
          </section>
          <section id="section6">
            <p className="mb-2.5 text-[#333] mt-[10px]">
            ...
            <p className="mb-2.5 text-justify leading-relaxed hyphens-auto">
              ...
              chỉnh làm mới cho vỏ, mặt kính cũng như dây đeo của đồng hồ, Trung
              tâm bảo hành Wristly cung cấp dịch vụ đánh bóng dây đeo, vỏ và mặt
              kính đồng hồ.
            </p>
          </section>
          <section id="section7">
            ...
            <p className="mb-2.5 text-justify leading-relaxed hyphens-auto">
              ...
              xuất đưa ra trong thông số kĩ thuật. Nếu như mức sai số trên đồng
              hồ của bạn không giống với thông số kĩ thuật mà hãng đưa ra thì
              quý khách có thể mang sản phẩm đến Trung tâm bảo hành Wristly để
              được kiểm tra.
            </p>
          </section>
          <section id="section8">
            ...
            <p className="mb-2.5 text-justify leading-relaxed hyphens-auto">
              ...
              tra chi tiết cho khách hàng. Nhân viên tiếp nhận sẽ báo với quý
            ...
            <p className="mb-2.5 text-justify leading-relaxed hyphens-auto">
              ...
              hiện vào biên nhận. Tùy vào trường hợp có thể sửa đồng hồ ngay
              hoặc để lại từ 1 đến 7 ngày vì phụ thuộc vào sự phức tạp của mỗi
            ...
            <p className="mb-2.5 text-justify leading-relaxed hyphens-auto">
              ...
              trợ tối đa cho vấn đề của Quý khách.
            </p>
          </section>
          <section id="section9">
