...
export default function Main() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch(
        "https://wristlybackend-e89d41f05169.herokuapp.com/product/allsp/gioitinh-nam10sp"
      );
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch(
        "https://wristlybackend-e89d41f05169.herokuapp.com/product/allsp/gioitinh-nu10sp"
      );
      const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch(
        "https://wristlybackend-e89d41f05169.herokuapp.com/product/allsp/doi10sp"
      );
      const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch(
        "https://wristlybackend-e89d41f05169.herokuapp.com/product/limit/gioitinh-nam"
      );
      const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch(
        "https://wristlybackend-e89d41f05169.herokuapp.com/product/limit/gioitinh-nu"
      );
      const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch("https://wristlybackend-e89d41f05169.herokuapp.com/product/limit/doi");
      const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch("https://wristlybackend-e89d41f05169.herokuapp.com/voucher/getvoucher");
      const data = await response.json();
                ...
                <div className={cx("w-[100%]")}>
                  ...
                  >
                    <img
                      ...
                      src={`https://wristlybackend-e89d41f05169.herokuapp.com/images/${item.hinh_anh2}`}
                      className={cx("")}
                    />
                  </Link>
                </div>
